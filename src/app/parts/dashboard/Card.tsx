...
export default async function CardWrapper() {
  ...
  return (
    <div className='flex flex-col md:flex-row items-center justify-between gap-2'>
      ...
      <Card title="Registered Agents" value={"1800"} type="agents" image={line} />
...
export function Card({
 image,
  ...
  return (
    <div className="w-[365px] border-2 border-[var(--border-color] p-4 rounded-lg flex flex-col gap-6">
